...
| <a name="input_platformName"></a> [platformName](#input\_platformName) | Platform name, e.g., google | `string` | `"google"` | no |
| <a name="input_projectId"></a> [projectId](#input\_projectId) | GCP project ID | `string` | `"slovink-hyperscaler"` | no |
